...
class PredefinedReportGenerator:
    ...
    def generate_front_desk_performance_report(date_range='last_30_days', start_date=None, end_date=None):
        ...
        # For task creation, we need a separate filter on created_at (which is the creation time)
        # Re-use logic but apply to created_at
        creation_date_filter, _, _, _, _, _ = PredefinedReportGenerator._get_date_filter(
        ...
        # New: Tasks Created by Front Desk
