...
import type { FrontDeskPerformanceReport } from '../types';

interface FrontDeskPerformancePreviewProps {
  data: FrontDeskPerformanceReport;
}

export const FrontDeskPerformancePreview: React.FC<FrontDeskPerformancePreviewProps> = ({ data }) => {
